...
// сервиса доставки еды. Выполни рефакторинг методов объекта customer, расставив отсутствующие this 
// при обращении к свойствам объекта.

// После объявления объекта мы добавили вызовы методов в той последовательности, в которой твой код 
...
// Тестировщики нашли баги в коде сервиса хранения истории заказов еды. Тебе необходимо исправить 
// их, правильно расставив this в методах объекта historyService, чтобы методы начали работать правильно.
...
//   console.log (new Car("Audi", "Q3", 36000));   // получится объект { brand: "Audi", model: "Q3", price: 36000 }
//   console.log (new Car("BMW", "X5", 58900));   // получится объект { brand: "BMW", model: "X5", price: 58900 }
//   console.log (new Car("Nissan","Murano", 31700));   // получится объект { brand: "Nissan", model: "Murano", price: 31700 }
...
//   console.log (new Car({ brand: "Audi", model: "Q3", price: 36000 }));   // получится объект { brand: "Audi", model: "Q3", price: 36000 }
//   console.log (new Car({ brand: "BMW", model: "X5", price: 58900 }));   // получится объект { brand: "BMW", model: "X5", price: 58900 }
//   console.log (new Car({ brand: "Nissan", model: "Murano", price: 31700 }));   // получится объект { brand: "Nissan", model: "Murano", price: 31700 }
...
// свойствами email и accessLevel. Добавь классу Admin публичное свойство accessLevel, значение которого 
